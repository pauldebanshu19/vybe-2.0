...
export default function Dashboard() {
  ...
  const generateImage = async () => {
    ...
    try {
      ...
      const contents = [
        { text: customPrompt || "Please create an image showing how this dress would look on this image of the person given." },
        {
          inlineData: {
    ...
    <div className="flex flex-col items-center justify-start min-h-screen py-4">
      <main className="container mx-auto p-4">
        ...
        <Card className="mb-4 glow-border">
          ...
          <CardContent>
            <Textarea
              placeholder="Enter your custom prompt to guide the AI generation (e.g., 'Show how this dress would look on this person with evening lighting')"
              value={customPrompt}
              onChange={(e) => setCustomPrompt(e.target.value)}
              className="min-h-24"
            />
            <p className="text-sm text-gray-500 mt-2">
              Customize how the AI generates your virtual try-on by providing specific instructions.
            </p>
          </CardContent>
        </Card>
